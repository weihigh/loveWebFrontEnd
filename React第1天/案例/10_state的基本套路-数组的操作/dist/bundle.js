...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.state = {
            "students": [{ "id": 10001, "name": "小明" }, { "id": 10002, "name": "小花" }, { "id": 10003, "name": "小强" }, { "id": 10004, "name": "小刚炮" }]
        };
        return _this;
    }
    ...
    _createClass(App, [{
        ...
        value: function zeng() {
            ...
            this.setState({
                "students": [].concat(_toConsumableArray(this.state.students), [{ "id": this.state.students.reduce(function (a, b) {
        ...
        key: "shan",
        value: function shan(id) {
            this.setState({
                "students": this.state.students.filter(function (item) {
                    return item.id != id;
                })
            });
        }
