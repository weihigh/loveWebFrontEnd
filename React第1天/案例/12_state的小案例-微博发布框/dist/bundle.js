    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                "div",
                null,
                _react2.default.createElement("textarea", { cols: "30", rows: "10", onChange: function onChange(e) {
                        _this2.setTxt(e.target.value);
                    } }),
                _react2.default.createElement(
                    "span",
                    { className: (0, _classnames2.default)({ "hong": this.state.txt.length > 140 }) },
                    "\u5B57\u6570\uFF1A",
                ...
                _react2.default.createElement(
                    "button",
                    { disabled: this.state.txt.length > 140 || this.state.txt.length == 0 },
                    "\u53D1\u5E03"
                )
            );
        }
