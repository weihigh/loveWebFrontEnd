...
var power = function power(a) {
    return a * a;
};

//定义一个函数，这个函数返回jsx
var sayHello = function sayHello(sex) {
    if (sex == "男") {
...
//返回一个图片的地址
var showPic = function showPic(picname) {
    if (picname == "孙杨") {
        return "images/0.jpg";
    } else if (picname == "女排") {
        return "images/1.jpg";
...
var element = _react2.default.createElement(
    ...
    _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("img", { src: showPic('孙杨'), width: w })
    ),
    _react2.default.createElement(
        "div",
        { className: "spec" },
...
_reactDom2.default.render(element, document.querySelector("#app-container"));
