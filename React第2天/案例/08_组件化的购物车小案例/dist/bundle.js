...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.state = {
            "cart": [{ "id": 10001, "name": "电脑", "price": 5600, "amount": 1 }, { "id": 10002, "name": "鼠标", "price": 200, "amount": 1 }, { "id": 10003, "name": "键盘", "price": 300, "amount": 1 }, { "id": 10004, "name": "U盘", "price": 500, "amount": 3 }]
        };
        return _this;
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.state.cart.map(function (item, index) {
                    return _react2.default.createElement(_Bar2.default, { key: index, thing: _this2.state.cart[index], setAmount: _this2.setAmount.bind(_this2), delThing: _this2.delThing.bind(_this2) });
                }),
                _react2.default.createElement("div", { className: "cl" }),
...
var Bar = function (_React$Component) {
    ...
    _createClass(Bar, [{
        ...
        value: function render() {
            ...
            var _props$thing = this.props.thing,
                id = _props$thing.id,
                amount = _props$thing.amount,
                name = _props$thing.name,
                price = _props$thing.price;
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", {
                        ...
                        onChange: function onChange(e) {
                            _this2.props.setAmount(id, Number(e.target.value));
                        }
                    }),
                    " ",
                    _react2.default.createElement(
                        "button",
                        {
                            onClick: function onClick() {
                                _this2.props.setAmount(id, amount + 1);
                            }
                        },
                        "+"
                    )
